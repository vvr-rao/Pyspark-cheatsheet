...
10) MLlib requires RDD and requires features to be numerical (e.g One Hot Encode categorical vars) This is dependent on model.e.g. for Random Forest and simple strng indexer is fine
11) Also models handle missing data and scaling differently. Random forst does not need Scaling. Regression and KNN does. Missing values can be replaced by something out of range for Random Forest. KNN and regression needs more thought
